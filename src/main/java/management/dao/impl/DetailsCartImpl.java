...
public class DetailsCartImpl implements IDetailsCartDao {
	...
	public double getTotalAmountOfBillItems() {
		...
		String hql = "SELECT SUM(dup.price * dc.quantity) " + "FROM DetailsCart dc " + "JOIN dc.detailsUpdatePrice dup "
	...
	@Override
	public List<DetailsCart> getDetailsCartsOfCustomerYetBuy(int idCustomer) {
		Session s = sessionFactory.openSession();

		String hql = "select dc from DetailsCart dc where dc.customer.id = ? and dc.bill is null";
	...
	@Override
	public List<DetailsCart> getDetailsCartsOfCustomerWasBought(int idCustomer) {
		Session s = sessionFactory.openSession();
