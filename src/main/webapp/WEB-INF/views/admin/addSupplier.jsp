									...
									<form action="./add-supplier" id="form-supplier"
										...
										<div class="form-group">
											<label for="" class="form-label">Địa chỉ</label> <input
												...
												placeholder="Nhập địa chỉ của NCC"> <span
												class="text--error"></span>
										</div>
										<div class="form-button-setting">
											<button class="btn btn-primary form-button submit"
												type="submit">Hoàn thành</button>

											<button class="btn btn-secondary form-button reset"
