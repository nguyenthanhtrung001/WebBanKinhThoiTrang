			...
			<div class="col l-12">
				...
				<c:choose>
   					<c:when test="${checkCategoryId != null}">
   						<form action="<c:url value='/user/product/${checkCategoryId}'/>" id="formSubmit" method="get">
   					...
   					<c:when test="${checkSearch != null}">
   						<form action="<c:url value='/user/product?search=${checkSearch}'/>" id="formSubmit" method="get">
								<div class="card-footer clearfix">
								<ul id="pagination-demo" class="pagination-lg"></ul>
								<input type="hidden" value="1" id="page" name="page" /> <input
									type="hidden" value="1" id="limit" name="limit" />
   					...
   					<c:otherwise>
   						<form action="<c:url value='/user/product'/>" id="formSubmit" method="get">
							<div class="card-footer clearfix">
								<ul id="pagination-demo" class="pagination-lg"></ul>
								<input type="hidden" value="1" id="page" name="page" /> <input
									type="hidden" value="1" id="limit" name="limit" />
